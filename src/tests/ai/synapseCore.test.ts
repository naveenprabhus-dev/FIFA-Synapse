...
describe('FIFA Synapse Core Unit & Integration Tests', () => {
  // 1. Test Intent Engine
  it('Intent Engine Classification', () => {
  ...
  it('Response Parser with Clean and Corrupted JSON', () => {
  ...
  it('Decision Engine Heuristics', async () => {
  ...
  it('Prompt Builder Template Compilation', async () => {
    const contextBuilder = new ContextBuilder(
      mockUserRepo,
      mockMatchRepo,
      mockCrowdRepo,
  ...
  it('SynapseCore Integrated Pipeline', async () => {
    const intentEngine = new IntentEngine();
    const contextBuilder = new ContextBuilder(
      mockUserRepo,
      mockMatchRepo,
  ...
  it('SynapseCore Fallback Recovery on Failure', async () => {
    const intentEngine = new IntentEngine();
    const contextBuilder = new ContextBuilder(
      mockUserRepo,
      mockMatchRepo,
  ...
  it('Gemini Provider Architecture & Prompt Templates', async () => {
    const contextBuilder = new ContextBuilder(
      mockUserRepo,
      mockMatchRepo,
      mockCrowdRepo,
